...
{
       0,    42,    42,    46,    47,    50,    55,    59,    60,    66,
      70,   101,   109,   113,   119,   123,   129,   130,   134,   138,
     145,   153,   157,   163,   168
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "WORD", "ARG", "CD",
  "NOTOKEN", "GREAT", "GREAT2", "NEWLINE", "LESS", "LESS2", "AND", "PIPE",
...
{
       1,    -1,    -2,     4,    -2,    -2,    12,     0,    -2,    -2,
      10,    -2,    -2,     7,    -2,    -2,    -2,    17,    18,    24,
      25,    20,    27,    22,    21,    -2,    -2,    -2,    -2,    -2,
      -2,    -2,    -2,    -2,    -2,    -2,    21
};
...
{
       0,     0,    20,     0,     7,    12,     0,     0,     3,     5,
       0,    17,    13,     0,    11,     1,     4,     0,     0,     0,
       0,     0,     0,     0,    14,    10,     9,    21,    22,    23,
       8,    17,     6,    18,    19,    16,    15
};
...
{
      -2,    -2,    -2,    26,    -2,    -2,     3,    -2,    13,    -2
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     6,     7,     8,     9,    10,    24,    35,    11,    23
};
...
{
      -2,     1,     1,     2,     2,     3,     3,    13,    12,     4,
       4,    17,    15,    14,     5,     5,    25,    18,    19,   -24,
      20,    27,    21,    22,    33,    34,    26,    28,    29,    30,
       2,    32,     0,    16,    36,    31
};
...
{
       0,     1,     1,     3,     3,     5,     5,     3,     9,     9,
       9,     1,     0,     9,    14,    14,     9,     7,     8,     9,
      10,     3,    12,    13,     3,     4,     9,     3,     3,     9,
       3,     9,    -1,     7,    31,    22
};
...
{
       0,     1,     3,     5,     9,    14,    16,    17,    18,    19,
      20,    23,     9,     3,     9,     0,    18,     1,     7,     8,
      10,    12,    13,    24,    21,     9,     9,     3,     3,     3,
       9,    23,     9,     3,     4,    22,    21
};
...
#line 1260 "y.tab.c"
  ...
  case 15: /* command_and_args: command_and_args PIPE command_word arg_list  */
#line 123 "shell.y"
                                                      {
...
#line 1306 "y.tab.c"
  ...
  case 22: /* iomodifier_opt: GREAT2 WORD  */
#line 157 "shell.y"
                     {
	//	printf("   Yacc: insert output 3 \"%s\"\n", $2);
		Command::_currentCommand._outFile = (yyvsp[0].string_val);
